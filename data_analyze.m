...
clf; hold on; plN=15; dt=1;
plot(effAll(1:dt:end,1:plN),'r') %pref-att
%
plot(effAll(1:dt:end,15+(1:plN)),'b') %square
%
plot(effAll(1:dt:end,30+(1:plN)),'g') %small world
...
plot(idRem(1:dt:end,15+(1:plN)),'b') %square
plot(idRem(1:dt:end,30+(1:plN)),'g') %small world
