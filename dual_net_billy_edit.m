...
% (small world) networks. Global efficiency is calcualted used the function
% efficiency_bin.m which I've also added to repo. Not seeing much change to
% the transient of the efficiency of idConn (idea correlation matrix) as I
% change the topologies... Maybe I need to run it on bigger networks? -
% Billy
...
hold on
for plotn=1:rng_seed
    plot(glob_eff_plot_data(plotn, :), color)
end
hold off
